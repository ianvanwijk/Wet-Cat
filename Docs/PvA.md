...
| rol | uitgevoerd door |
|-----|------------------|
| De opdrachtgever heeft als rol om akkoord te geven bij het beginnen van het project, hij zal contact hebben met het projectteam om het status van het project bij te houden en zal aan het einde van het project traject goedkeuring geven van het eindproduct. | none yet  |
